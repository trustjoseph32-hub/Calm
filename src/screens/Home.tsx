    ...
    <div className="flex-1 flex flex-col items-center px-4 py-4 sm:py-8 max-w-2xl mx-auto w-full h-full min-h-[100svh]">
      <header className="w-full flex justify-between items-center mb-4 sm:mb-12">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-semibold tracking-tight bg-gradient-to-br from-indigo-400 to-indigo-200 bg-clip-text text-transparent">Panic Attack Club</h1>
      ...
      <main className="w-full flex-1 flex flex-col justify-center gap-3 sm:gap-6 pb-2 sm:pb-20">
        <button 
          ...
          className="flex flex-col text-left bg-red-950/30 p-4 sm:p-8 rounded-3xl sm:rounded-[2rem] shadow-sm border border-red-900/50 hover:border-red-800/50 hover:shadow-md transition-all active:scale-[0.98] group relative overflow-hidden"
        >
          ...
          <div className="flex items-center gap-4 sm:gap-6 relative z-10">
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-b from-red-400 via-red-600 to-red-800 text-white flex items-center justify-center shrink-0 border border-red-300/40 shadow-[inset_0_2px_4px_rgba(255,255,255,0.5),inset_0_-4px_6px_rgba(0,0,0,0.5),0_6px_12px_rgba(220,38,38,0.4)]">
              <Zap className="w-6 h-6 sm:w-8 sm:h-8 fill-red-100 drop-shadow-md" strokeWidth={1.5} />
            </div>
            <div>
              <h3 className="text-lg sm:text-2xl font-medium text-red-100">Скорая помощь (SOS)</h3>
              <p className="text-sm sm:text-base text-red-200/70 mt-1 sm:mt-2">Экстренная практика для быстрого снижения тревоги</p>
            </div>
          </div>
        </button>
        ...
        <button 
          ...
          className="flex flex-col text-left bg-indigo-950/20 p-4 sm:p-8 rounded-3xl sm:rounded-[2rem] shadow-sm border border-indigo-900/40 hover:border-indigo-800/50 hover:shadow-md transition-all active:scale-[0.98] group relative overflow-hidden"
        >
          ...
          <div className="flex items-center gap-4 sm:gap-6 relative z-10">
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-b from-indigo-400 via-indigo-600 to-indigo-800 text-white flex items-center justify-center shrink-0 border border-indigo-300/40 shadow-[inset_0_2px_4px_rgba(255,255,255,0.5),inset_0_-4px_6px_rgba(0,0,0,0.5),0_6px_12px_rgba(79,70,229,0.4)]">
              <Pill className="w-6 h-6 sm:w-8 sm:h-8 text-indigo-50 fill-indigo-200/20 drop-shadow-md" strokeWidth={1.5} />
            </div>
            <div>
              <h3 className="text-lg sm:text-2xl font-medium text-indigo-100">Пройти курс</h3>
              <p className="text-sm sm:text-base text-indigo-200/70 mt-1 sm:mt-2">День {courseProgress.currentDay} из 14</p>
            </div>
          </div>
        </button>
        ...
        <button 
          ...
          className="flex flex-col text-left bg-neutral-800 p-4 sm:p-8 rounded-3xl sm:rounded-[2rem] shadow-sm border border-neutral-700 hover:border-neutral-700 hover:shadow-md transition-all active:scale-[0.98] group relative overflow-hidden"
        >
          ...
          <div className="flex items-center gap-4 sm:gap-6 relative z-10">
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-gradient-to-b from-neutral-600 via-neutral-700 to-neutral-900 text-neutral-200 flex items-center justify-center shrink-0 border border-neutral-400/40 shadow-[inset_0_2px_4px_rgba(255,255,255,0.3),inset_0_-4px_6px_rgba(0,0,0,0.6),0_6px_12px_rgba(0,0,0,0.3)]">
              <BookOpen className="w-6 h-6 sm:w-8 sm:h-8 drop-shadow-md" strokeWidth={1.5} />
            </div>
            <div>
              <h3 className="text-lg sm:text-2xl font-medium text-neutral-100">Инструкция</h3>
              <p className="text-sm sm:text-base text-neutral-500 mt-1 sm:mt-2">Как работают практики</p>
            </div>
          </div>
        </button>
      </main>
