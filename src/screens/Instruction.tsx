...
export function Instruction() {
  ...
  return (
    <div className="flex-1 flex flex-col px-4 py-8 max-w-2xl mx-auto w-full min-h-screen bg-transparent">
      ...
      <main className="flex-1 flex flex-col gap-6 pb-12">
        <section className="bg-white/10 p-6 sm:p-8 rounded-3xl shadow-sm border border-white/10">
        ...
        <section className="bg-white/10 p-6 sm:p-8 rounded-3xl shadow-sm border border-white/10">
          ...
          <div className="flex flex-col gap-5">
            <div className="flex gap-4">
              ...
              <p className="text-slate-500 pt-1 leading-relaxed">Обратить внимание на свои мысли во время тревожности.</p>
            </div>
            <div className="flex gap-4">
              ...
              <p className="text-slate-500 pt-1 leading-relaxed">Оценить по шкале от 0 до 10 интенсивность проявления реакции от мыслей.</p>
            </div>
            <div className="flex gap-4">
              ...
              <p className="text-slate-500 pt-1 leading-relaxed">Обратить внимание на телесный отклик тревожности. На его локализацию (голова, горло, грудь, верх живота, низ живота).</p>
            </div>
            <div className="flex gap-4">
              ...
              <p className="text-slate-500 pt-1 leading-relaxed">Оценить по шкале от 0 до 10 интенсивность проявления телесной реакции.</p>
            </div>
            <div className="flex gap-4">
        ...
        <section className="bg-white/10 p-6 sm:p-8 rounded-3xl shadow-sm border border-white/10">
          <div className="w-12 h-12 rounded-full bg-gradient-to-b from-neutral-600 via-neutral-700 to-neutral-900 flex items-center justify-center mb-6 border border-neutral-400/40 shadow-[inset_0_2px_4px_rgba(255,255,255,0.3),inset_0_-4px_6px_rgba(0,0,0,0.6),0_6px_12px_rgba(0,0,0,0.3)] text-blue-100/80 drop-shadow-md">
        ...
        <section className="bg-white/10 p-6 sm:p-8 rounded-3xl shadow-sm border border-white/10">
          ...
          <ul className="space-y-4 text-slate-500 leading-relaxed list-disc pl-5">
