...
export const COURSE_DAYS_DATA: CourseDayInfo[] = [
  ...
  },
  {
    ...
    practiceType: 'B',
    period: 'learning',
    periodLabel: 'Этап 1 • Вторая техника',
    title: 'Ритм + опора',
    focusTitle: 'Освоение второй практики',
    focusText: 'Сегодня знакомимся и осваиваем вторую технику курса — «Ритм + опора». Соединяем ритмичный тэппинг, спокойное дыхание и долгий выдох с гудением.',
    instructionTitle: 'План занятия',
    instructionText: '1. Тэппинг: поочередное похлопывание по плечам.\n2. Дыхание и звук: вдох носом (4 сек) и выдох с гудением «мммм» (6 сек).\n3. Синхронизация: ритм и голос вместе.\n4. Закрепление: общая сессия на 2.5 минуты + 1 минута тишины.',
    practiceDurationSec: 300,
    exposureDurationSec: 60,
  },
  {
  ...
  },
  {
    ...
    focusText: 'Сегодня в практике «Ритм + опора» можно попробовать второй вариант: скрестить ладони на верхней части груди (ключицах) — «объятие бабочки».',
  ...
  },
  {
    ...
    focusText: 'Финальный день курса. Выберите ту практику, которая вам ближе: «Внимание + дыхание» или «Ритм + опора». Пройдите полный самостоятельный цикл.',
    instructionTitle: 'Выбор техники',
    instructionText: 'Выберите практику: «Внимание + дыхание» (дыхание + взгляд + кулаки) или «Ритм + опора» (тэппинг + выдох + голос). Зафиксируйте ощущение до и после.',
    practiceDurationSec: 240,
    exposureDurationSec: 180,
  },
];
