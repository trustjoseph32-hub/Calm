...
export const COURSE_DAYS_DATA: CourseDayInfo[] = [
  ...
  },
  {
    ...
    instructionTitle: 'План занятия',
    instructionText: '1. Уши: легкие ритмичные постукивания подушечками пальцев для мягкой стимуляции блуждающего нерва.\n2. Плечи: поочерёдные перекрёстные постукивания пальцами («прикосновения бабочки») для билатеральной регуляции.\n3. Верхняя часть грудины: мягкие постукивания ладонью (чуть ниже ямки на шее) для снятия накопленного напряжения.\n4. Закрепление: выполнение упражнения + выдох со звуком «мммм» и 1 минута тишины.',
    practiceDurationSec: 330,
    exposureDurationSec: 60,
  },
  {
    day: 3,
