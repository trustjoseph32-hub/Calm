...
const targetStr = `      <main className="flex-1 flex flex-col justify-center gap-12 max-w-md mx-auto w-full pb-12">`;

const replacement = `      <div className="mb-8">
...
console.log("Patched SosInstruction");
